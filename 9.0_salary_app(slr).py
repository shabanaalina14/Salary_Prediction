...
#Streamlit is great for turning data scripts into shareable web apps quickly and efficiently.
import pickle
import numpy as np

# Load the saved model
model = pickle.load(open(r"C:\Users\shaba\OneDrive\github\machine_learning\linear_regression_pickle", 'rb'))
